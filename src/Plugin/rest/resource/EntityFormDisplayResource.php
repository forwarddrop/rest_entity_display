...
/**
 * Provides a resource for rendering field widgets for REST.
 *
 * @RestResource(
 *   id = "rest_form_entity_display",
 *   label = @Translation("TODO"),
 *   uri_paths = {
 *     "canonical" = "/rest_entity_form_display/{entity_type_id}/{id}/{view_mode}/{operation}"
 *   }
 * )
 */
class EntityViewDisplayResource extends ResourceBase {
  ...
  /**
   * @var \Drupal\rest_entity_display\RestEntityFormDisplayRenderer
   */
  protected $renderer;
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $container->get('rest_entity_display.form_renderer')
    );
  }
   ...
   */
  public function get($entity_type_id = NULL, $id = NULL, $view_mode = NULL, $operation = NULL) {
    if (!$entity_type_id) {
    ...
    if ($id) {
      ...
      $view_builder = $this->entityTypeManager->getFormObject($entity_type_id, $operation);
